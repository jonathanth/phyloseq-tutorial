...
####
# tax_table is a special char. matrix that contains taxonomy information on features/ASVs. Can also put other feature metadata in there.
tax_table(phy)[1:10,]
...
###
# refseq are the reference sequences
refseq(phy)
